...
class Extras extends Component {
    ...
    formSubmit = (e) => {
        ...
        try
           {
            var format=localStorage.getItem("fomrat")
        ...
        return (
            <div className="card animated fadeInLeft">
                ...
                <form onSubmit={this.formSubmit}>
                    ...
                    <img src="https://cdn.pixabay.com/photo/2021/12/27/17/47/animal-6897849__340.jpg" height="100px" class="img-fluid" alt="Responsive image"/>
                    </div>
                    <div className="col-md-6">
                    <img src="https://cdn.pixabay.com/photo/2021/12/27/17/47/animal-6897849__340.jpg" height="100px" class="img-fluid" alt="Responsive image"/>
